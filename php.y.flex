...
<HARD_COMPLEX_INSERT,PHP>"++"						{ return INCREMENT; }
<HARD_COMPLEX_INSERT,PHP>"--"						{ return DECREMENT; }
<HARD_COMPLEX_INSERT,PHP>"!" 						{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>"*" 						{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>"*=" 						{ return MULT_ASSIGN; }
<HARD_COMPLEX_INSERT,PHP>"**" 						{ return POW; }
<HARD_COMPLEX_INSERT,PHP>"**=" 						{ return POW_ASSIGN; }
<HARD_COMPLEX_INSERT,PHP>"/" 						{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>"/=" 						{ return DIV_ASSIGN; }
<HARD_COMPLEX_INSERT,PHP>"%" 						{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>"+" 						{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>"+=" 						{ return PLUS_ASSIGN; }
<HARD_COMPLEX_INSERT,PHP>"." 						{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>".=" 						{ return CONCAT_ASSIGN; }
<PHP>"," 											{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>"-" 						{ return *yytext; }
<HARD_COMPLEX_INSERT,PHP>"-=" 						{ return MINUS_ASSIGN; }
<HARD_COMPLEX_INSERT,PHP>"<<" 						{ return LEFT_SHIFT; }
<HARD_COMPLEX_INSERT,PHP>">>" 						{ return RIGHT_SHIFT; }
<HARD_COMPLEX_INSERT,PHP>"<<=" 						{ return LEFT_SHIFT_ASSIGN; }
<HARD_COMPLEX_INSERT,PHP>">>=" 						{ return RIGHT_SHIFT_ASSIGN; }
<HARD_COMPLEX_INSERT,PHP>"<" 						{ return *yytext; }
...
<HARD_COMPLEX_INSERT,PHP,SIMPLE_SQUARE_BRACKETS>{ID}					{ strcpy(yylval.id_const, yytext); return FLOAT;}
